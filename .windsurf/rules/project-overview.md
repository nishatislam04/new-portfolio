...
- **run local server**: after implementing feature, never start or restart local dev server to test. as the local server was always running on [port 3000](http://192.168.0.103:3000)

---

### Project bootstrap details

Project runs Next.js dev server bound to host 192.168.0.103 on port 3000 (-H 192.168.0.103). Use this when invoking MCP/browser to target [http://192.168.0.103:3000](http://192.168.0.103:3000). MCP Next.js tools are available for server management.
