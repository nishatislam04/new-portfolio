...
export const StaggerContainer = dynamic(
	() => import("./StaggerContainer").then((m) => m.StaggerContainer),
	{
		ssr: false,
		loading: () => null,
	},
...
export const FadeInOnScroll = dynamic(
	() => import("./FadeInOnScroll").then((m) => m.FadeInOnScroll),
	{
		ssr: false,
		loading: () => null,
	},
...
export const TechStackCard = dynamic(
	() => import("./TechStackCard").then((m) => m.TechStackCard),
	{
		ssr: false,
		loading: () => null,
	},
