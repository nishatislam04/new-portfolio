...
export default function Footer() {
	return (
		<footer className="relative z-20 overflow-x-clip">
			<div className="absolute h-[300px] w-[1600px] bottom-0 left-1/2 -translate-x-1/2 bg-emerald-300/40 mask-[radial-gradient(50%_50%_at_bottom_center,black,transparent)] -z-10"></div>
			<Container>
