...
const ToolboxItem = ({ item, index }: { item: typeof toolboxItems[0]; index: number }) => (
  ...
  >
    ...
    <span className="text-white font-medium text-sm bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
      {item.title}
    </span>
  </motion.div>
);
          ...
          <FadeIn delay={0.4}>
            <div className="text-center mt-12">
              <p className="text-gray-400 text-sm">
                And many more tools and technologies that I continue to explore and master.
              </p>
            </div>
          </FadeIn>
        </StaggerContainer>
