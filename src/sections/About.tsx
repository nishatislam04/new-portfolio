							...
							<FadeIn delay={0.2}>
								<div className="space-y-6">
									...
									<p className="body-base text-gray-300 leading-relaxed">
										...
										{PERSONAL_INFO.workExperience[0].company} as a{" "}
										{PERSONAL_INFO.workExperience[0].position}, I specialize in
										modern web technologies including React, Next.js, Laravel,
										and Vue.js. I believe in writing clean, maintainable code
