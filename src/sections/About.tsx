        ...
        <StaggerContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              <FadeIn delay={0.2}>
                <div className="space-y-6">
                  ...
                  <p className="body-base text-gray-300 leading-relaxed">
                    Currently working at {PERSONAL_INFO.workExperience[0].company} as a {PERSONAL_INFO.workExperience[0].position},
            ...
            <div className="space-y-8">
              ...
              <FadeIn delay={0.5}>
                <div className="space-y-6">
                  <h3 className="heading-3 text-center">My Toolbox</h3>
                    ...
                    {techStack.map((tech, index) => (
                      ...
                      >
                        <Card variant="glass" className="p-4 text-center group hover:border-blue-500/30 transition-all duration-300">
                          ...
                          <p className="text-sm font-medium bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-blue-500 transition-all duration-300">
                            {tech.name}
                          </p>
                        </Card>
                      </motion.div>
